...
|-----------------|--------------|---------------|----------|
| Human Internal | 0.636 | 0.493 | 0.566 |
| Llm Internal | 0.871 | 0.833 | 0.870 |
...
- **Human Internal** shows moderate consistency (Pearson r = 0.636)
- **Llm Internal** shows high consistency (Pearson r = 0.871)
